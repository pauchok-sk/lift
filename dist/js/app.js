(() => {
    ...
    function validate() {
        ...
        if (modalFormCall) modalFormCall.addField("#order-call-name", [ {
            rule: "minLength",
            value: 3,
        ...
        if (document.querySelector("#form-connection")) {
            ...
            formConnection.addField("#connection-name", [ {
                rule: "minLength",
                value: 3,
                errorMessage: "Минимум 3 символа"
            }, {
    ...
    function maskToggle() {
        ...
        if (buttons.length) buttons.forEach((btn => btn.addEventListener("click", (() => {
    ...
    function slider() {
        ...
        if (gallerySliders.length) gallerySliders.forEach((slider => {
            const buttonsSlider = slider.closest(".gallery__item").querySelectorAll(".gallery__nav-btn");
    ...
    function selectImage() {
        ...
        if (selects.length) selects.forEach((s => {
            const image = s.querySelector(".select-image__btn").querySelector("img");
            s.addEventListener("click", (e => {
                const target = e.target;
                if (target.closest(".select-image__item-btn")) image.src = target.src;
            }));
        }));
    }
    ...
    function fancy() {
        Oe.bind('[data-fancybox="gallery-1"]', {});
        Oe.bind('[data-fancybox="gallery-2"]', {});
        Oe.bind('[data-fancybox="gallery-3"]', {});
        Oe.bind('[data-fancybox="gallery-4"]', {});
